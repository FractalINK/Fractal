...
if RunService:IsStudio() then
    ...
    Library.MinSize = Library.IsMobile and Vector2.new(480, 240)
    ...
    if ExtraOffset then
        return UDim2.new(
            ...
            (Dimension.X.Offset * Library.DPIScale)
                + (ExtraOffset[1] * Library.DPIScale),
            Dimension.Y.Scale,
            (Dimension.Y.Offset * Library.DPIScale)
                + (ExtraOffset[2] * Library.DPIScale)
        )
    end
...
function Library:UpdateKeybindFrame()
    ...
    for _, KeybindToggle in pairs(Library.KeybindToggles) do
        ...
        local FullSize = KeybindToggle.Label.Size.X.Offset
            + KeybindToggle.Label.Position.X.Offset
    ...
    Library.KeybindFrame.Size =
        UDim2.fromOffset(XSize + 18 * Library.DPIScale, 0)
end
    ...
    for Instance, Properties in pairs(Library.DPIRegistry) do
        for Property, Value in pairs(Properties) do
            ...
            elseif Property == 'TextSize' then
                ...
                Instance[Property] =
                    ApplyDPIScale(Value, Properties['DPIOffset'][Property])
            end
        end
    end
...
local function FillInstance(Table: { [string]: any }, Instance: GuiObject)
    ...
    for k, v in pairs(Table) do
        ...
        elseif
            k ~= 'Text' and (Library.Scheme[v] or typeof(v) == 'function')
        then
...
function Library:AddDraggableButton(Text: string, Func)
    ...
    function Table:SetText(NewText: string)
        ...
        Button.Text = NewText
        Button.Size =
            UDim2.fromOffset(X * Library.DPIScale * 2, Y * Library.DPIScale * 2)
...
function Library:AddContextMenu(
    ...
    if List then
        Menu = New('ScrollingFrame', {
            AutomaticCanvasSize = List == 2 and Enum.AutomaticSize.Y
                or Enum.AutomaticSize.None,
            AutomaticSize = List == 1 and Enum.AutomaticSize.Y
                or Enum.AutomaticSize.None,
            BackgroundColor3 = 'BackgroundColor',
    ...
    function Table:Open()
        ...
        Table.Signal = Holder:GetPropertyChangedSignal('AbsolutePosition')
            :Connect(function()
                if typeof(Offset) == 'function' then
                    Menu.Position = UDim2.fromOffset(
                        math.floor(Holder.AbsolutePosition.X + Offset()[1]),
...
TooltipLabel:GetPropertyChangedSignal('AbsolutePosition'):Connect(function()
    ...
    TooltipLabel.Size =
        UDim2.fromOffset(X + 8 * Library.DPIScale, Y + 4 * Library.DPIScale)
...
function Library:AddTooltip(
    ...
    local function DoHover()
        if
            ...
            or (CurrentMenu and Library:MouseIsOverFrame(
                CurrentMenu.Menu,
                Mouse
            ))
        ...
        while
            ...
            and not (
                CurrentMenu
                and Library:MouseIsOverFrame(CurrentMenu.Menu, Mouse)
            )
        do
    ...
    table.insert(
        ...
        HoverInstance.MouseEnter:Connect(DoHover)
    )
    table.insert(
        TooltipTable.Signals,
        HoverInstance.MouseMoved:Connect(DoHover)
    )
    table.insert(
        TooltipTable.Signals,
    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        do
            ...
            local CheckImage = New('ImageLabel', {
                ...
                ImageRectOffset = CheckIcon and CheckIcon.ImageRectOffset
                    or Vector2.zero,
                ImageRectSize = CheckIcon and CheckIcon.ImageRectSize
                    or Vector2.zero,
                ImageTransparency = 1,
                Position = UDim2.fromOffset(2, 2),
                Size = UDim2.new(1, -4, 1, -4),
            ...
            function KeybindsToggle:SetText(Text)
                local X =
                    Library:GetTextBounds(Text, Label.FontFace, Label.TextSize)
                Label.Text = Text
            ...
            function KeybindsToggle:SetNormal(Normal)
                ...
                Label.Position = Normal and UDim2.fromOffset(0, 0)
                    or UDim2.fromOffset(22 * Library.DPIScale, 0)
        ...
        function KeyPicker:Display()
            ...
            Picker.Size = UDim2.fromOffset(
                X + 9 * Library.DPIScale,
                Y + 4 * Library.DPIScale
            )
        end
        ...
        Picker.MouseButton1Click:Connect(function()
            ...
            Picker.Text = '...'
            Picker.Size =
                UDim2.fromOffset(29 * Library.DPIScale, 18 * Library.DPIScale)

            local Input = UserInputService.InputBegan:Wait()
            local Key = 'Unknown'

            if Input.UserInputType == Enum.UserInputType.Keyboard then
                Key = Input.KeyCode == Enum.KeyCode.Escape and 'None'
            ...
            Library:SafeCallback(
                ...
                Input.KeyCode == Enum.KeyCode.Unknown and Input.UserInputType
                    or Input.KeyCode
            )
            Library:SafeCallback(
                KeyPicker.Changed,
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        do
            ...
            CreateButton('Copy color', function()
                Library.CopiedColor =
                    { ColorPicker.Value, ColorPicker.Transparency }
            end)
        ...
        function ColorPicker:Display()
            ...
            SatVibCursor.Position =
                UDim2.fromScale(ColorPicker.Sat, 1 - ColorPicker.Vib)
            HueCursor.Position = UDim2.fromScale(0.5, ColorPicker.Hue)
            if TransparencyCursor then
                TransparencyCursor.Position =
                    UDim2.fromScale(0.5, ColorPicker.Transparency)
            end
        ...
        SatVipMap.MouseButton1Down:Connect(function()
            while
                UserInputService:IsMouseButtonPressed(
                    Enum.UserInputType.MouseButton1 or Enum.UserInputType.Touch
                )
            do
        ...
        if TransparencySelector then
            TransparencySelector.MouseButton1Down:Connect(function()
                ...
                do
                    ...
                    local Max = TransparencySelector.AbsolutePosition.Y
...
do
    ...
    function Funcs:AddLabel(...)
        ...
        local TextLabel = New('TextLabel', {
            ...
            TextXAlignment = Groupbox.IsKeyTab and Enum.TextXAlignment.Center
        ...
        if Data.DoesWrap then
            ...
            TextLabel:GetPropertyChangedSignal('AbsoluteSize')
                :Connect(function()
                    ...
                    TextLabel.Size =
                        UDim2.new(1, 0, 0, Y + 4 * Library.DPIScale)
    ...
    function Funcs:AddButton(...)
        ...
        local function CreateButton(Button)
            local Base = New('TextButton', {
                ...
                BackgroundColor3 = Button.Disabled and 'BackgroundColor'
                    or 'MainColor',
                Size = UDim2.fromScale(1, 1),
                Text = Button.Text,
                TextSize = 14,
        ...
        local function InitEvents(Button)
            ...
            Button.Base.MouseButton1Click:Connect(function()
                ...
                if Button.DoubleClick then
                    ...
                    local Clicked =
                        WaitForEvent(Button.Base.MouseButton1Click, 0.5)

                    Button.Base.Text = Button.Text
                    Button.Base.TextColor3 = Button.Risky and Library.Scheme.Red
        ...
        function Button:AddButton(...)
            ...
            function SubButton:UpdateColors()
                ...
                SubButton.Base.TextTransparency = SubButton.Disabled and 0.8
                    or 0.4
            ...
            if
                typeof(SubButton.Tooltip) == 'string'
    ...
    function Funcs:AddCheckbox(Idx, Info)
        ...
        function Toggle:Display()
            ...
            TweenService
                :Create(Label, Library.TweenInfo, {
                    TextTransparency = Toggle.Value and 0 or 0.4,
                })
                :Play()
            TweenService
                :Create(CheckImage, Library.TweenInfo, {
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        function Toggle:Display()
            ...
            Switch.BackgroundColor3 = Toggle.Value
                ...
                or Library.Scheme.MainColor
            SwitchStroke.Color = Toggle.Value and Library.Scheme.AccentColor
            ...
            if Toggle.Disabled then
                ...
                Ball.BackgroundColor3 =
                    Library:GetDarkerColor(Library.Scheme.FontColor)
    ...
    function Funcs:AddInput(Idx, Info)
        ...
        then
            Input.TooltipTable =
                Library:AddTooltip(Input.Tooltip, Input.DisabledTooltip, Box)
            Input.TooltipTable.Disabled = Input.Disabled
        end
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        Bar.MouseButton1Down:Connect(function()
            ...
            do
                ...
                local Scale = math.clamp(
                    (Location - Bar.AbsolutePosition.X) / Bar.AbsoluteSize.X,
                    0,
                    1
                )
                ...
                Slider.Value =
                    Round(Slider.Min + ((Slider.Max - Slider.Min) * Scale))
        ...
        if
            typeof(Slider.Tooltip) == 'string'
            or typeof(Slider.DisabledTooltip) == 'string'
        then
            Slider.TooltipTable =
                Library:AddTooltip(Slider.Tooltip, Slider.DisabledTooltip, Bar)
            Slider.TooltipTable.Disabled = Slider.Disabled
        end
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        local ArrowImage = New('ImageLabel', {
            ...
            ImageColor3 = 'FontColor',
            ImageRectOffset = ArrowIcon and ArrowIcon.ImageRectOffset
                or Vector2.zero,
            ImageRectSize = ArrowIcon and ArrowIcon.ImageRectSize
                or Vector2.zero,
        ...
        function Dropdown:RecalculateListSize(Count)
            local Y = math.clamp(
                (Count or GetTableSize(Dropdown.Values))
                    * (21 * Library.DPIScale),
                0,
        ...
        function Dropdown:UpdateColors()
            ...
            ArrowImage.ImageTransparency = Dropdown.Disabled and 0.8
                or MenuTable.Active and 0
                or 0.5
        end
            ...
            if Info.Multi then
                for _, Value in pairs(Dropdown.Values) do
                    if Dropdown.Value[Value] then
                        Str = Str
                            .. (Info.FormatDisplayValue and tostring(
        ...
        function Dropdown:BuildDropdownList()
            ...
            for _, Value in pairs(Values) do
                if
                    SearchBox
                    and not tostring(Value)
                        :lower()
                        :match(SearchBox.Text:lower())
                then
                    continue
                end
        ...
        function Dropdown:SetText(Text: string)
            Dropdown.Text = Text
            Holder.Size =
                UDim2.new(1, 0, 0, (Text and 39 or 21) * Library.DPIScale)
        ...
        if
            typeof(Dropdown.Tooltip) == 'string'
...
function Library:Notify(...)
    ...
    local Background =
        Library:MakeOutline(FakeBackground, Library.CornerRadius, 5)
    Background.AutomaticSize = Enum.AutomaticSize.Y
    Background.Position = Library.NotifySide:lower() == 'left'
            and UDim2.new(-1, -6, 0, -2)
        or UDim2.new(1, 6, 0, -2)
    ...
    function Data:Resize()
        ...
        FakeBackground.Size = UDim2.fromOffset(
            (TitleX > DescX and TitleX or DescX) + (24 * Library.DPIScale),
            0
        )
    end
    ...
    if Data.SoundId then
        New('Sound', {
            SoundId = 'rbxassetid://'
                .. tostring(Data.SoundId):gsub('rbxassetid://', ''),
            Volume = 3,
            PlayOnRemove = true,
            Parent = SoundService,
        }):Destroy()
...
function Library:CreateWindow(WindowInfo)
    ...
    Library.MinSize = Vector2.new(
        math.min(Library.MinSize.X, MaxX),
        math.min(Library.MinSize.Y, MaxY)
    )
    ...
    do
        ...
        New('ImageLabel', {
            ...
            ImageColor3 = 'FontColor',
            ImageRectOffset = ResizeIcon and ResizeIcon.ImageRectOffset
                or Vector2.zero,
            ImageRectSize = ResizeIcon and ResizeIcon.ImageRectSize
                or Vector2.zero,
            ImageTransparency = 0.5,
            Position = UDim2.fromOffset(2, 2),
            Size = UDim2.new(1, -4, 1, -4),
    ...
    function Window:AddTab(Name: string, Icon)
        ...
        do
            ...
            do
                ...
                TabLeft.Size = UDim2.new(
                    0,
                    math.floor(TabContainer.AbsoluteSize.X / 2) - 3,
                    1,
                    0
                )
        ...
        function Tab:UpdateWarningBox(Info)
            ...
            WarningBox.BackgroundColor3 = Info.IsNormal == true
                    and Library.Scheme.BackgroundColor
                or Color3.fromRGB(127, 0, 0)
            WarningBox.BorderColor3 = Info.IsNormal == true
                    and Library.Scheme.OutlineColor
                or Color3.fromRGB(255, 50, 50)
            WarningTitle.TextColor3 = Info.IsNormal == true
                    and Library.Scheme.FontColor
                or Color3.fromRGB(255, 50, 50)
            WarningStroke.Color = Info.IsNormal == true
                    and Library.Scheme.OutlineColor
            ...
            Library.Registry[WarningBox].BackgroundColor3 = function()
                return Info.IsNormal == true and Library.Scheme.BackgroundColor
                    or Color3.fromRGB(127, 0, 0)
            end

            Library.Registry[WarningBox].BorderColor3 = function()
                return Info.IsNormal == true and Library.Scheme.OutlineColor
                    or Color3.fromRGB(255, 50, 50)
            end

            Library.Registry[WarningTitle].TextColor3 = function()
                return Info.IsNormal == true and Library.Scheme.FontColor
                    or Color3.fromRGB(255, 50, 50)
            end
        ...
        function Tab:Resize(ResizeWarningBox: boolean?)
            ...
            local Offset = WarningBox.Visible and WarningBox.AbsoluteSize.Y + 6
                or 0
            for _, Side in pairs(Tab.Sides) do
                Side.Position = UDim2.new(Side.Position.X.Scale, 0, 0, Offset)
                
                local IsFull = (Side == TabFull)
                Side.Size = UDim2.new(
                    IsFull and 1 or 0,
                    IsFull and 0 or (math.floor(TabContainer.AbsoluteSize.X / 2) - 3),
                    1,
                    -Offset
                )
        ...
        function Tab:AddGroupbox(Info)
            local Background = Library:MakeOutline(
                Info.Side == 1 and TabLeft or (Info.Side == 2 and TabRight or TabFull),
        ...
        function Tab:AddTabbox(Info)
            local Background = Library:MakeOutline(
                Info.Side == 1 and TabLeft or TabRight,
                WindowInfo.CornerRadius
            )
            Background.Size = UDim2.fromScale(1, 0)
            Library:UpdateDPI(Background, {
            ...
            function Tabbox:AddTab(Name)
                ...
                function Tab:Resize()
                    ...
                    Background.Size = UDim2.new(
                        ...
                        0,
                        0,
                        List.AbsoluteContentSize.Y + 53 * Library.DPIScale
                    )
                end
        ...
        function Tab:Hover(Hovering)
            ...
            TweenService
                :Create(TabLabel, Library.TweenInfo, {
                    TextTransparency = Hovering and 0.25 or 0.5,
                })
                :Play()
            if TabIcon then
                TweenService
                    :Create(TabIcon, Library.TweenInfo, {
	...
	function Window:RegisterAddon(Name: string, Icon)
        local AddonTab = Window:AddTab(Name, Icon)
        
        AddonTab.IsAddon = true
        AddonTab.AddonName = Name
        
        Library.Addons = Library.Addons or {}
        Library.Addons[Name] = AddonTab
    ...
    function Library:Toggle(Value: boolean?)
        ...
        if Library.Toggled and not Library.IsMobile then
            ...
            RunService:BindToRenderStep(
                ...
                function()
                    ...
                    if
                        not (Library.Toggled and ScreenGui and ScreenGui.Parent)
                    then
        ...
        elseif not Library.Toggled then
            ...
            for _, Option in pairs(Library.Options) do
                ...
                elseif
                    Option.Type == 'Dropdown' or Option.Type == 'KeyPicker'
                then
                    Option.Menu:Close()
                end
            end
...
local function OnPlayerChange()
    ...
    for _, Dropdown in pairs(Options) do
        if Dropdown.Type == 'Dropdown' and Dropdown.SpecialType == 'Player' then
            Dropdown:SetValues(
                Dropdown.ExcludeLocalPlayer and ExcludedPlayerList or PlayerList
            )
        end
    end
end
